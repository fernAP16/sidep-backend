...
public class ColaPesajeController {
    ...
    @PostMapping("/obtenerDespachoById/{idColaPesaje}")
    public DespachoDatosOutDto obtenerDatosDespacho(@PathVariable Integer idColaPesaje){
        return colaPesajeService.obtenerDatosDespacho(idColaPesaje);
    }
